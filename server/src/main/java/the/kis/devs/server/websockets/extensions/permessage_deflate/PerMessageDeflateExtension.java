package the.kis.devs.server.websockets.extensions.permessage_deflate;

import the.kis.devs.server.websockets.enums.Opcode;
import the.kis.devs.server.websockets.exceptions.InvalidDataException;
import the.kis.devs.server.websockets.exceptions.InvalidFrameException;
import the.kis.devs.server.websockets.extensions.CompressionExtension;
import the.kis.devs.server.websockets.extensions.ExtensionRequestData;
