...
public final class AStarPathFinder extends AbstractNodeCostSearch {
    ...
    protected Optional<IPath> calculate0(long primaryTimeout, long failureTimeout) {
        ...
        Baritone.LOGGER.info(numMovementsConsidered + " movements considered");
        Baritone.LOGGER.info("Open set size: " + openSet.size());
        Baritone.LOGGER.info("PathNode map size: " + mapSize());
        Baritone.LOGGER.info((int) (numNodes * 1.0 / ((System.currentTimeMillis() - startTime) / 1000F)) + " nodes per second");
