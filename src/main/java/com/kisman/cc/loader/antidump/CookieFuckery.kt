...
interface CookieFuckery {
	...
	companion object: CookieFuckery {
		...
		override fun setPackageNameFilter() {
			val bytes = createDummyClass("the/kis/devs/lavafalcon/antidump/MaliciousClassFilter")
			unsafe.defineClass("the.kis.devs.lavafalcon.antidump.MaliciousClassFilter", bytes, 0, bytes.size, null, null)
			System.setProperty("sun.jvm.hotspot.tools.jcore.filter", "the.kis.devs.lavafalcon.antidump.MaliciousClassFilter")
		}
