package com.kisman.cc.features.module.Debug.futureshader;
...
public abstract class Shader {
    ...
    public Shader(String fragment, String folder) {
        int vertexShaderID;
        int fragmentShaderID;
        try {
            final InputStream vertexStream = this.getClass().getResourceAsStream("/assets/kismancc/shader/fragment/future/" + folder + "/vertex.glsl");
            vertexShaderID = this.createShader(IOUtils.toString(vertexStream, Charset.defaultCharset()), 35633);
            IOUtils.closeQuietly(vertexStream);
            final InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/kismancc/shader/fragment/future/" + folder + "/" + fragment + "glsl");
