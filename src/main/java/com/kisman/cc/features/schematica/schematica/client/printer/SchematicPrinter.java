package com.kisman.cc.features.schematica.schematica.client.printer;

import com.kisman.cc.Kisman;
import com.kisman.cc.event.events.schematica.EventSchematicaPlaceBlock;
import com.kisman.cc.event.events.schematica.EventSchematicaPlaceBlockFull;
...
import com.kisman.cc.features.schematica.schematica.client.printer.nbtsync.NBTSync;
import com.kisman.cc.features.schematica.schematica.client.printer.nbtsync.SyncRegistry;
import com.kisman.cc.features.schematica.schematica.client.printer.registry.PlacementData;
import com.kisman.cc.features.schematica.schematica.client.printer.registry.PlacementRegistry;
import com.kisman.cc.features.schematica.schematica.client.util.BlockStateToItemStack;
...
public class SchematicPrinter
{
   ...
   //     this.isPrinting = false;
    ...
    private List<EnumFacing> getSolidSides(final World world, final BlockPos pos)
    {
        ...
        //TODO
        boolean l_LiquidInteract = false;//ModuleManager.Get().GetMod(LiquidInteractModule.class).isEnabled();
    ...
    private boolean placeBlock(final WorldClient world, final EntityPlayerSP player, final BlockPos pos, final IBlockState blockState, final ItemStack itemStack)
    {
        ...
        Kisman.EVENT_BUS.post(new EventSchematicaPlaceBlock(pos));
        ...
        EventSchematicaPlaceBlockFull event = new EventSchematicaPlaceBlockFull(pos, itemStack.getItem());
        
        Kisman.EVENT_BUS.post(event);

        return event.isCancelled() ? event.result : placeBlock(world, player, pos, direction, offsetX, offsetY, offsetZ, extraClicks);
    }
