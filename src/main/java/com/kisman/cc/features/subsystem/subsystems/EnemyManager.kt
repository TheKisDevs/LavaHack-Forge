...
//    private var minDistanceEntity = Double.MAX_VALUE
    ...
    private val updateEntity = Listener<EventUpdateEntity>(EventHook {
        if(mc.player != null) {
            ...
            if (entity is EntityPlayer && entity !is IFakeEntity && entity != mc.player && (!AntiBot.instance.isToggled || !AntiBot.instance.mode.checkValString("Zamorozka") || !EntityUtil.antibotCheck(entity)) && !FriendManager.instance.isFriend(entity)) {
