...
public class PvpResources extends ShaderableHudModule {
    ...
    private final Runnable3P<Integer, Integer, String> stringRenderer = (x, y, string) -> drawStringWithShadow(string, x + 19 - 2 - CustomFontUtil.getStringWidth(string), y + 6 + 3, -1);
