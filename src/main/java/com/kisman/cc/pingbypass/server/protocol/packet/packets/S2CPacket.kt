 ...
 */
abstract class S2CPacket(
    private val id : Int
) : SPacketCustomPayload(
    "PingBypass",
    PacketBuffer(Unpooled.buffer())
),
    PingBypassPacket<INetHandlerPlayClient>,
    IPacket
{
    override fun getId(): Int = getState().getPacketId(EnumPacketDirection.CLIENTBOUND, SPCP)
    ...
    companion object {
        private val SPCP = SPacketCustomPayload()
    }
}