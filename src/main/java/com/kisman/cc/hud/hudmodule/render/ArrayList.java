                ...
                switch (HUD.instance.arrGragient.getValString()) {
                    ...
                    case "Sideway": {
                        ...
                        for(int i = 0; i < mod.getName().length(); ++i) {
                            ...
                            CustomFontUtil.drawStringWithShadow(str, update, HUD.instance.arrY.getValDouble() + (heigth * count), ColorUtils.injectAlpha(ColorUtils.rainbow(i * HUD.instance.arrGradientDiff.getValInt(), hsb[1], Managers.instance.pulseManager.getDifference(count * 2) / 255f), 255).getRGB());
