...
public class Radar extends HudModule {
    ...
    public void onRender(RenderGameOverlayEvent.Text event) {
        ...
        if(isNorth) {
            Render2DUtil.drawRect(150 / 2 - 0.5 - 6 + x, 150 / 2 - 0.5 + y, 150 / 2 - 0.5 + x, 150 / 2 + 0.5 + y, color);
        } else if(isSouth) {
            Render2DUtil.drawRect(150 / 2 + 0.5 + x, 150 / 2 - 0.5 + y, 150 / 2 + 0.5 + 6 + x, 150 / 2 - 0.5 + y, color);
        } else if(isEast) {
            Render2DUtil.drawRect(150 / 2 - 0.5 + x, 150 / 2 - 0.5 - 6 + y, 150 / 2 + 0.5 + x, 150 / 2 - 0.5 + y, color);
        } else if(isWest) {
            Render2DUtil.drawRect(150 / 2 - 0.5 + x, 150 / 2 + 0.5 + y, 150 / 2 + 0.5 + x, 150 / 2 + 0.5 + 6 + y, color);
        }
    ...
    private void drawLine(int x, int y, int x1, int y1, int color) {
