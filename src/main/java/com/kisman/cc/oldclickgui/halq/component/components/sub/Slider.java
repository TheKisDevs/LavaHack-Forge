...
public class Slider extends Component {
    ...
    public Slider(Setting setting, int x, int y, int offset) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if(HalqGui.shadowCheckBox) Render2DUtil.drawAbstract(new AbstractGradient(new Vec4d(new double[] {x, y + offset}, new double[] {x + width, y + offset}, new double[] {x + width, y + offset + HalqGui.height}, new double[] {x, y + offset + HalqGui.height}), HalqGui.primaryColor, ColorUtils.injectAlpha(HalqGui.backgroundColor, 4)));
        else Render2DUtil.drawRectWH(x, y + offset, width, HalqGui.height, HalqGui.primaryColor.getRGB());
