...
//    public Setting glowOffset = register(glow.add(new Setting("Glow Offset", this, 6, 1, 20, true)));
    ...
    public Setting particlesColor = register(particles.add(new Setting("Particles Color", this, "Particles Dots Color", new Colour(0, 0, 255))));
    ...
    public Setting particlesGStartColor = register(particles.add(new Setting("Particles Gradient StartColor", this, "Particles Gradient StartColor", new Colour(0, 0, 255)).setVisible(() -> guiParticles.getValBoolean() && !particlesGradientMode.getValString().equalsIgnoreCase(ParticlesGradientMode.None.name()) && particlesRenderLine.getValBoolean())));
    public Setting particlesGEndColor = register(particles.add(new Setting("Particles Gradient EndColor", this, "Particles Gradient EndColor", new Colour(0, 0, 255)).setVisible(() -> guiParticles.getValBoolean() && !particlesGradientMode.getValString().equalsIgnoreCase(ParticlesGradientMode.None.name()) && particlesRenderLine.getValBoolean())));
...
//    public Setting depthFix = register(other.add(new Setting("Depth Fix", this, true)));
    ...
    public enum NameMode {kismancc, LavaHack, TheKisDevs, kidman, TheClient, BloomWare, UwU, kidmad, EarthHack, custom}
