...
public class Color extends Module {
    public Color() {
        ...
        Kisman.instance.settingsManager.rSetting(new Setting("RLine", this, 256, 0, 256, true));
        Kisman.instance.settingsManager.rSetting(new Setting("GLine", this, 0, 0, 256, true));
        Kisman.instance.settingsManager.rSetting(new Setting("BLine", this, 0, 0, 256, true));
        Kisman.instance.settingsManager.rSetting(new Setting("RBackground", this, 80, 0, 256, true));
        Kisman.instance.settingsManager.rSetting(new Setting("GBackground", this, 75, 0, 256, true));
        Kisman.instance.settingsManager.rSetting(new Setting("BBackground", this, 75, 0, 256, true));
    }
