...
//    }
//
//    public static void drawTotalCenteredStringWithShadow(String text, int x, int y, int color) {
//        drawStringWithShadow(text, x - fontRenderer.getStringWidth(text) / 2, y - fontRenderer.FONT_HEIGHT / 2, color);
//    }
//}
