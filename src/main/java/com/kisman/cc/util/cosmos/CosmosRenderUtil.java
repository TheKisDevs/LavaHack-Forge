...
public class CosmosRenderUtil {
	...
	public static void drawBorder(float x, float y, float width, float height, int color) {
		CosmosRenderUtil.drawRect(x - 1, y - 1, 1, height + 2, color);
		CosmosRenderUtil.drawRect(x + width, y - 1, 1, height + 2, color);
		CosmosRenderUtil.drawRect(x, y - 1, width, 1, color);
		CosmosRenderUtil.drawRect(x, y + height, width, 1, color);
	}
