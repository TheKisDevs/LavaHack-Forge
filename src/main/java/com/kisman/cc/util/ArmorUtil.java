...
//        if(Minecraft.getMinecraft().player.inventory.armorInventory[slot] != null) {
//            int currentIndex = 0;
//            int invIndex = 0;
...
//            for(int i = 0; i < j; i++) {
//                int armor = array[i];
//                if(Item.getIdFromItem(Minecraft.getMinecraft().player.inventory.armorInventory[slot].getItem()) == armor) {
...
//        for(int i = 9; i < 45; i++) {
//            ItemStack item = Minecraft.getMinecraft().player.inventoryContainer.getSlot(i).getStack();
