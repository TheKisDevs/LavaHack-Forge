...
//    WireOutlineGradient(Rendering.Mode.WIRE_OUTLINE_GRADIENT),
    ChromaFilled(Rendering.Mode.CHROMABOX),
    ChromaOutline(Rendering.Mode.CHROMAOUTLINE),
    ChromaFilledOutline(Rendering.Mode.CHROMABOX_CHROMAOUTLINE),
    OutlineChromaFilled(Rendering.Mode.CHROMABOX_OUTLINE),
    FilledChromaOutline(Rendering.Mode.BOX_CHROMAOUTLINE)
}