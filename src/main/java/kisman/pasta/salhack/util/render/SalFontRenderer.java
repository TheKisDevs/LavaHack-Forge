...
public class SalFontRenderer
{
    ...
    {
        if (name == "Tw Cen MT")
            return getFontFromInput("/assets/kismancc/font/tcm.TTF");
        if (name == "Tw Cen MT Std")
            return getFontFromInput("/assets/kismancc/font/TwCenMTStd-Bold.ttf");
        if (name == "Verdana Bold")
            return getFontFromInput("/assets/kismancc/font/verdanabold.ttf");
        if (name == "Lucida Console")
            return getFontFromInput("/assets/kismancc/font/lucdia-console.ttf");
        if (name == "VerdanaBold")
            return getFontFromInput("/assets/kismancc/font/verdanabold.ttf");
